...
// The response message containing person's data
type SendPersonData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SendPersonData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendPersonData) ProtoMessage() {}

func (x *SendPersonData) ProtoReflect() protoreflect.Message {
	mi := &file_person_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendPersonData.ProtoReflect.Descriptor instead.
func (*SendPersonData) Descriptor() ([]byte, []int) {
	return file_person_proto_rawDescGZIP(), []int{1}
}

func (x *SendPersonData) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_person_proto_rawDesc = []byte{
	...
	,
}
...
var file_person_proto_goTypes = []interface{}{
	...
	(*SendPersonData)(nil), // 1: main.SendPersonData
}
var file_person_proto_depIdxs = []int32{
	0, // 0: main.GetPerson.PersonData:input_type -> main.Person
	1, // 1: main.GetPerson.PersonData:output_type -> main.SendPersonData
